...
|---|---|---|---|
| 2026-06-22 | `fix-shim-bin-path` | 修复 brooks-tools 离线安装失败：Part G 新增 .js→shell wrapper 自动生成 + node_modules/.bin 兜底合并 · install_brooks_tools.sh find+chmod 兜底 · 重打包 bundle | — |
