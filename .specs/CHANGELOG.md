...
|---|---|---|---|
| 2026-06-09 | `fix-brooks-registration` | 修复 install_brooks_lint() 向 installed_plugins.json 写入格式与 Claude Code v2 不匹配的 bug：补 installPath/scope/camelCase/namespaced-key → SessionStart hook 停止静默失效 | — |
