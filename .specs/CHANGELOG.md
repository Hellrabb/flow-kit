...
|---|---|---|---|
| 2026-06-22 | `docs-update` | 更新 FLOW-KIT-用户指南.md (+145行)：新增 §4.1 Goal 系统与 Pipeline 执行模型（pipeline goal / PCSC-PG 双层防护 / rollback 智能回退 / goal 自动提取）。README.md 文件名引用修正。全链路 0→7 pipeline 自动执行 | — |
